...
$widgets = array(
				...
				'includes/widgets/widget-woo-social.php', 
				'includes/widgets/widget-woo-postmeta.php', 
				'includes/widgets/widget-woo-twitter.php', 
				'includes/widgets/widget-woo-subscribe.php', 
				'includes/widgets/widget-woo-feedback.php', 
				'includes/widgets/widget-woo-blog.php', 
				'includes/widgets/widget-woo-portfolio.php'
				);
