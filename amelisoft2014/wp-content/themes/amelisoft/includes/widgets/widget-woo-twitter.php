...
class Woo_Twitter extends WP_Widget {
	...
	function Woo_Twitter() {
		$widget_ops = array( 'description' => __( 'Add your Twitter feed to your sidebar with this widget.', 'woothemes' ) );
	...
	function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			?><h3 class="tlogo"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" alt="Twitter" /></h3><?php
		}
		?><div class="back"><ul id="twitter_update_list_<?php echo $unique_id; ?>"><li></li></ul>
			<p><?php _e( 'Follow', 'woothemes' ); ?> <a href="http://twitter.com/<?php echo $username; ?>"><strong>@<?php echo $username; ?></strong></a> <?php _e( 'on Twitter', 'woothemes' ); ?></p></div><div class="clear"></div><?php
