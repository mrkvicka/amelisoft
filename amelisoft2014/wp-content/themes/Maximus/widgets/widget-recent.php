			...
			<?php while($loop->have_posts()) :
				...
				<li>
					<a href="<?php the_permalink() ?>">
						<?php if ($show_thumbnail) the_post_thumbnail($thumb_size, array('class' => 'pic_left', 'title' => false)); ?>
						<strong class="news_title"><?php the_title(); ?></strong>
						<?php if ($show_excerpt): ?><span class="news_short"><?php echo get_the_excerpt(); ?></span><?php endif; ?>
